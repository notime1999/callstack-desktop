...
import { Player, PlayerRole, VoiceMode } from '../../shared/types';
...
export class OverlayComponent implements OnInit, OnDestroy {
  ...
  voiceMode = signal<VoiceMode>('default');
  teamName = signal('');

  ngOnInit(): void {
    // Listen for overlay data from main process
    if (window.electronAPI) {
      window.electronAPI.onOverlayData((data: unknown) => {
        const overlayData = data as OverlayData;
