...
import { Team, Player, PlayerRole } from '@tactical-voice/shared-types';
...
describe('TeamService', () => {
  ...
  describe('isIGL', () => {
    ...
    it('should return false if current player is not IGL', () => {
      const team: Team = {
        ...mockTeam,
        players: [{ ...mockPlayer, role: 'player' as PlayerRole }]
      };
  ...
  describe('canSpeak', () => {
    ...
    it('should not allow player to speak in clutch mode', () => {
      ...
      const playerOnlyTeam: Team = {
        ...mockTeam,
        leaderId: 'other-leader', // Different leader
        players: [{ ...mockPlayer, role: 'player' as PlayerRole }]
      };
      ...
      (service as any)._voiceMode.set('clutch');
