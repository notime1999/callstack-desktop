...
let InviteModalComponent = class InviteModalComponent {
    constructor() {
        this.teamId = '';
...
__decorate([
    Input()
], InviteModalComponent.prototype, "teamId", void 0);
__decorate([
    Output()
], InviteModalComponent.prototype, "close", void 0);
InviteModalComponent = __decorate([
    Component({
